...
impl Canvas {
    ...
    /// Rasterize the canvas to an RGBA Pixmap.
    pub fn rasterize_pixmap(&self, px_width: u32, px_height: u32) -> Pixmap {
        ...
        for line in &self.lines {
            Self::rasterize_line_onto(&mut pixmap, line, scale_x, scale_y);
        }
        pixmap
    }
